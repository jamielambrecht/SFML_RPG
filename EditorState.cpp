...
void EditorState::initPauseMenu()
{
	...
	this->pmenu->addButton("SAVE", gui::p2pY(70.f, vm), gui::p2pX(15.f, vm), gui::p2pY(7.f, vm), gui::calcCharSize(vm), "Save");
	this->pmenu->addButton("LOAD", gui::p2pY(77.f, vm), gui::p2pX(15.f, vm), gui::p2pY(7.f, vm), gui::calcCharSize(vm), "Load");
	this->pmenu->addButton("QUIT", gui::p2pY(84.f, vm), gui::p2pX(15.f, vm), gui::p2pY(7.f, vm), gui::calcCharSize(vm), "Quit");
}
