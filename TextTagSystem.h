...
enum TagTypes { DEFAULT_TAG = 0, NEGATIVE_TAG, POSITIVE_TAG, EXPERIENCE_TAG, ENVIRONMENTAL_TAG };
...
public:
	...
	void addTextTag(const unsigned tag_type, const float pos_x, const float pos_y, const int val, const std::string prefix, const std::string postfix);
	void addTextTag(const unsigned tag_type, const float pos_x, const float pos_y, const float val, const std::string prefix, const std::string postfix);
